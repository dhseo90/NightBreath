...
ITEMS=(
  ...
  "Home|Trend dashboard|Docs/Screenshots/Home/trend-dashboard.png|Docs/Screenshots/Home/cropped/trend-dashboard.png|release-approved"
  "Sleep|Morning check-in|Docs/Screenshots/Sleep/morning-check-in.png|Docs/Screenshots/Sleep/cropped/morning-check-in.png|release-approved"
  "Daily Rhythm|Evening check-in|Docs/Screenshots/DailyRhythm/evening-check-in.png|Docs/Screenshots/DailyRhythm/cropped/evening-check-in.png|release-approved"
  "Daily Rhythm|Daily Health Card export preview|Docs/Screenshots/DailyRhythm/daily-health-card-export-preview.png|Docs/Screenshots/DailyRhythm/cropped/daily-health-card-export-preview.png|release-approved"
