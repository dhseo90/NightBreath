...
ROOT_SCREEN_SMOKE_CHECKS=(
  ...
  'SleepSoundApp/App/AppState.swift|applyScreenshotSlowFinalizationState|Simulator QA must keep a slow finalization state for stop-delay review.'
  ...
  'SleepSoundApp/Features/Dashboard/HealthDashboardView.swift|HealthRefreshStateQAView|Health refresh feedback states must stay directly reviewable in DEBUG.'
  ...
  'SleepSoundApp/Features/Settings/DebugAudioSamplesView.swift|DebugAudioSamplesFixtureQAView|Debug audio sample multi-record fixture must stay directly reviewable.'
...
SCREENSHOT_DESTINATION_CHECKS=(
  ...
  'case .sleepFinalizingSlow:|Screenshot slow finalization destination is missing.'
  ...
  'case .privacySnapshot:|Screenshot privacy snapshot destination is missing.'
  'PrivacySnapshotCoverQAView()|Screenshot privacy snapshot view is missing.'
  'case .healthRefreshStates:|Screenshot health refresh states destination is missing.'
  'HealthRefreshStateQAView()|Screenshot health refresh QA view is missing.'
  'case .debugAudioSamplesFixture:|Screenshot debug audio samples fixture destination is missing.'
  'DebugAudioSamplesFixtureQAView()|Screenshot debug audio samples fixture view is missing.'
