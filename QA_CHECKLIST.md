...
- [ ] 이벤트 오디오 샘플의 저장 시간, 개수, 용량, 보관 기간 제한이 적용된다.
...
- [ ] 장시간 측정에서 이벤트가 0개일 때 raw 후보 수, smoothing 전/후 후보 수, threshold 탈락 이유를 확인할 수 있는 진단 로그가 필요하다.
- [ ] 이벤트 오디오 샘플 저장은 제품화 전 사용자 opt-in 설정으로 분리해야 한다.
