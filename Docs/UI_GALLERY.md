...
| `FitdaysImportView` | Fitdays export file 가져오기 | 파일 선택 상태, preview, imported/skipped/error row count, unknown column | 파일 선택, preview 확인, 로컬 저장 | 사용자가 직접 선택한 로컬 파일만 읽고 원격 연결 없음 | `ScreenshotFitdaysImportScenario` | `Docs/Screenshots/Health/cropped/fitdays_import_light.png` | ![FitdaysImportView](Screenshots/Health/cropped/fitdays_import_light.png) | Release | `Docs/FITDAYS_IMPORT.md`, `Docs/EXTENDED_HEALTH_METRICS.md` |
