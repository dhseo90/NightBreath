...
struct FitdaysImportServiceTests {
    ...
    func fitdaysImportViewExplainsTSVEmptyPreviewAndRecoveryWithoutServerFallback() throws {
        ...
        #expect(source.contains("데이터 확인 중"))
        ...
        #expect(source.contains("클립보드 붙여넣기"))
        #expect(source.contains("입력한 내용 확인"))
        ...
        #expect(source.contains("저장할 데이터"))
        #expect(source.contains("저장 준비 완료"))
        #expect(source.contains("로컬에 저장"))
        ...
        #expect(source.contains("저장 전 확인"))
