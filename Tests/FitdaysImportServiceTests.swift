...
struct FitdaysImportServiceTests {
    ...
    func fitdaysImportViewExplainsTSVEmptyPreviewAndRecoveryWithoutServerFallback() throws {
        ...
        #expect(source.contains("NBInlineStatus"))
        #expect(source.contains("미리보기 요청됨 · 분석 중"))
        #expect(source.contains("Fitdays 작업 완료 안 됨"))
        ...
        #expect(source.contains("클립보드 붙여넣고 저장 전 미리보기"))
        #expect(source.contains("저장 전 미리보기 만들기"))
        #expect(source.contains("월별 데이터 붙여넣기"))
        #expect(source.contains("FitdaysImportFlowStatus"))
        ...
        #expect(source.contains("미리보기 완료 · 아직 저장 전"))
        #expect(source.contains("미리보기 결과 로컬 저장"))
        ...
        #expect(source.contains("변환된 샘플만 기기 안 로컬 저장소에 저장했습니다."))
        ...
        #expect(source.contains("처리한 행"))
        #expect(source.contains("저장 가능"))
        #expect(source.contains("건너뛴 행 해석"))
        #expect(source.contains("지원하지 않는 열"))
